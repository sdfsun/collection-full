...
public class StatisticsBatchDto extends BizModel<String>{
	...
	//基础还款统计
		...
		private Double paid_achieve=0.00;
		private Double cp_back_paid=0.00;
		private Double cp_achieve=0.00;
	    ...
	    public Double getPaid_achieve() {
			return paid_achieve;
		}
		public void setPaid_achieve(Double paid_achieve) {
			this.paid_achieve = paid_achieve;
		}
		...
		public Double getCp_achieve() {
			return cp_achieve;
		}
		public void setCp_achieve(Double cp_achieve) {
			this.cp_achieve = cp_achieve;
		}
