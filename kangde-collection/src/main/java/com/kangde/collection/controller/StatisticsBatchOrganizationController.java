...
@Controller
@RequestMapping("collection/statisticsBatchOrganization")
public class StatisticsBatchOrganizationController extends RestfulUrlController<StatisticsBatchDto, String> {
	 ...
	 * 批次统计展示方法
	 */
	@RequestMapping(value = "queryBatchOrganization")
	@ResponseBody
	public SearchResult<StatisticsBatchDto> queryBatch() {
		ParamCondition condition = parseCondition("*");
		SearchResult<StatisticsBatchDto> queryBatch = statisticsService.queryBatchOrganization(condition);
		...
		for (StatisticsBatchDto batchDto : list) {
			...
			dto.setPhone_count(batchDto.getPhone_count()+dto.getPhone_count());
			dto.setVisit_count(batchDto.getVisit_count()+dto.getVisit_count());
			dto.setApply_count(batchDto.getApply_count()+dto.getApply_count());
			dto.setAssist_count(batchDto.getAssist_count()+dto.getAssist_count());
		}
	...
	protected String getBaseName() {
		return "collection/statisticsBatchOrganization/";
	}
