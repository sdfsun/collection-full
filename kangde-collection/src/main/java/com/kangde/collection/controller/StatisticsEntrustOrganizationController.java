...
@Controller
@RequestMapping("collection/statisticsEntrustOrganization")
public class StatisticsEntrustOrganizationController extends RestfulUrlController<StatisticsEntrustDto, String> {
	 ...
	 * 委托方统计展示方法
	 */
	@RequestMapping(value = "queryEntrustOrganization")
	@ResponseBody
	public SearchResult<StatisticsEntrustDto> queryEntrust() {
		...
		SearchResult<StatisticsEntrustDto> queryEntrust = statisticsService.queryEntrustOrganization(condition);
		...
		for (StatisticsEntrustDto entrustDto : list) {
			...
			dto.setPhone_count(entrustDto.getPhone_count()+dto.getPhone_count());
			dto.setVisit_count(entrustDto.getVisit_count()+dto.getVisit_count());
			dto.setApply_count(entrustDto.getApply_count()+dto.getApply_count());
			dto.setAssist_count(entrustDto.getAssist_count()+dto.getAssist_count());
	...
	protected String getBaseName() {
		return "collection/statisticsEntrustOrganization/";
	}
