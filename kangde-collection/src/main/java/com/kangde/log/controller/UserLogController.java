...
public class UserLogController extends AbstractController<UserLogModel,String>{
	...
	public ModelAndView pageShow(@PathVariable("id") String id) {
		UserLogModel model = super.findById(id);
	...
	public SearchResult<UserLogModel> queryForPage() {
