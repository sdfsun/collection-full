...
$.extend($.fn.validatebox.defaults.rules, {
    ...
    mobile: {
        ...
        message: '以13、14、15、17、18、开头的11位手机号码.'
    },
    phone: {//座机号码/固定电话验证
        validator: function(value, param){
            return /^(\([0-9]{3,4}\)|[0-9]{3,4}\-)[0-9]{7,8}$/.test(value);
        },
        message: '电话号码输入有误，匹配格式：区号3位或4位，号码7位或8位， <br/>区号与电话号码之间用小括号或"-"隔开.例如:"0791-88888888"'
    },
    mobileOrPhone: {//手机号码或固定电话验证
        validator: function(value, param){
            return (/^(13|15|18|14|17)\d{9}$/i.test(value)) || (/^(\([0-9]{3,4}\)|[0-9]{3,4}\-)[0-9]{7,8}$/.test(value));
        },
        message: '手机格式:以13、14、15、17、18开头的11位号码;  <br/>电话格式:区号3位或4位,号码7位或8位, <br/>区号与号码之间用小括号或"-"隔开.'
    },
    empty: {
        validator: function (value, param) {
    ...
    comboboxRequired: {
        validator: function (value, param) {
        	if(value=='请选择...' || value ==''){
        		return false;
        	}else if ("请选择"==value.substring(0,3)){
        		return false;
        	}
        	if(param != undefined){
