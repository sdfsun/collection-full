...
$.fn.pagination.defaults={total:1,pageSize:50,pageNumber:1,pageList:[50,200,500],loading:false,buttons:null,showPageList:true,showRefresh:true,links:10,layout:["list","sep","first","prev","sep","manual","sep","next","last","sep","refresh"],onSelectPage:function(_d1,_d2){
...
//modify 1 tree 默认同步
$.ajax({type:opts.method,async:opts.async==undefined?false:opts.async,url:opts.url,data:_1cc,dataType:"json",success:function(data){
_1cd(data);
},error:function(){
...
//modify 2,panel 默认为异步
$.ajax({type:opts.method,async:opts.async==undefined?true:opts.async,url:opts.href,cache:false,data:_26a,dataType:"html",success:function(data){
_26b(data);
},error:function(){
...
opts=$.extend({},$.messager.defaults,{content:"<div class=\"messager-icon messager-question\"></div>"+"<div class='messager-question-kd'>"+opts.msg+"</div>"+"<div style=\"clear:both;\"/>"},opts);
if(!opts.buttons){
opts.buttons=[{text:opts.ok,onClick:function(){
_2ad(dlg,true);
...
opts=$.extend({},$.messager.defaults,{content:"<div class=\"messager-icon messager-question\"></div>"+"<div  class='messager-question-kd'>"+opts.msg+"</div>"+"<br/>"+"<div style=\"clear:both;\"/>"+"<div><input class=\"messager-input\" type=\"text\"/></div>"},opts);
if(!opts.buttons){
opts.buttons=[{text:opts.ok,onClick:function(){
...
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{sharedStyleSheet:false,frozenColumns:undefined,columns:undefined,fitColumns:false,resizeHandle:"both",autoRowHeight:true,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,data:null,loadMsg:"Processing, please wait ...",rownumbers:false,singleSelect:false,ctrlSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:false,pagePosition:"bottom",pageNumber:1,pageSize:50,pageList:[50,200,500],queryParams:{},sortName:null,sortOrder:"asc",multiSort:false,remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowEvents:{mouseover:_64b(true),mouseout:_64b(false),click:_653,dblclick:_65d,contextmenu:_661},rowStyler:function(_7fd,_7fe){
},loader:function(_7ff,_800,_801){
var opts=$(this).datagrid("options");
if(!opts.url){
return false;
}
//modify 3 datagrid 默认异步
$.ajax({type:opts.method,async:opts.async==undefined?true:opts.async,url:opts.url,data:_7ff,dataType:"json",success:function(data){
_800(data);
},error:function(){
...
//modify 4 treegrid 默认异步
$.ajax({type:opts.method,async:opts.async==undefined?true:opts.async,url:opts.url,data:_966,dataType:"json",success:function(data){
_967(data);
},error:function(){
...
default:
if(opts.editable){
//start 源代码修改,修复combo输入中文检索问题-->lisuo-1.4.5
_9ad.combo.bind("input", function (e) {
if(_9ad.timer){
...
//modify 5 combo 默认同步
$.ajax({type:opts.method,async:opts.async==undefined?false:opts.async,url:opts.url,data:_a29,dataType:"json",success:function(data){
_a2a(data);
},error:function(){
