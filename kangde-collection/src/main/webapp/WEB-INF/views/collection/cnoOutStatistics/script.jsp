...
<script type="text/javascript" charset="utf-8">
	...
	var _search_form;
	//请求基础路径
	var baseUrl = ctx + "/collection/cnoOutStatistics";
...
// 			pageList : [ 20, 50, 100 ],
            ...
            {field : 'cno', title : '坐席号', width : 110,sortable:true},
 			{field : 'callOutCount', title : '外呼次数', width : 110,sortable:true},
 			{field : 'callOutConnectCount', title : '外呼接通次数', width : 110,sortable:true},
 			{field : 'callOutConnectDuration', title : '外呼接通时长', width : 110,sortable:true},
 			{field : 'callOutConnectDurationAvg', title : '平均外呼接通时长', width : 120,sortable:true},
