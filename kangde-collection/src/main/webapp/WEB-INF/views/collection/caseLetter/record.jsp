...
<jsp:include page="record_script.jsp"></jsp:include>
...
<div class="easyui-layout" fit="true"
	...
	<div
		...
		style="padding: 5px 0 0 0; height: 68px; width: 100%; overflow-y: hidden;">
		<form id="_search_form" class="search_form">
			<table>
				<tr>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;案件序列号&nbsp; <input name="caseCode" style="width:150px;height:23px;" class="easyui-validatebox textbox" width="150"/>
					</td>
				...
				<!-- 	<td>
					...
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;申请人&nbsp; <input name="applyUserName" style="width:150px;height:23px;" class="easyui-validatebox textbox"/>
					</td>
					<td>&nbsp;&nbsp;&nbsp;申请时间&nbsp; <input
						id="appTimeStart" name="appTimeStart"
				...
				<tr>
					...
					<td>&nbsp;&nbsp;&nbsp;证件号&nbsp; <input name="caseNum" style="width:150px;height:23px;" class="easyui-validatebox textbox"/>
					</td>
					<td>&nbsp;&nbsp;&nbsp;信函状态&nbsp; 
						<k:dictionary constName="LETTER_STATE" id="applyState" width="150" name="applyState" value="1"/>
					</td>
