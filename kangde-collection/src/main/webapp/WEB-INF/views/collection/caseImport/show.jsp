	...
	<form id="_form" class="dialog-form" method="post"
		...
		<tr height="10"></tr>
			<tr >
				...
				<td width="180px"><k:dictionary constName="CASE_TYPE" id='typeId' name="typeId" required="true" width="150"/></td>
			...
			<!-- 	<td >
				...
				<td align="right">批次号</td><td>&nbsp;<input id="batchCodeview" name="batchCode" type="text"
			...
			<tr>
				...
				<td colspan="3"><input id="remark" name="remark"
					...
					style="width: 441px; height: 160px" value="${remark }" /></td>
			</tr>
			<c:if test="${empty id }">
				<tr>
