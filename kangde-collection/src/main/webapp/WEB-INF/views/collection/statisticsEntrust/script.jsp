...
<script type="text/javascript" charset="utf-8">
	...
	var paid2_dialog;
	//请求基础路径
	var baseUrl = ctx + "/collection/statisticsEntrust";
	...
	$(function() {
		...
		_datagrid = $('#_datagrid').datagrid({
			...
			columns : [ [ 
              ...
              {field : 'cp_back_paid', title : '未确认佣金', width : 110,sortable:true,
	 			formatter : function(value, row, index) {
 					if (null==value) {
 						return "0.00";
 					}else if (''==value) {
              ...
              {field : 'paid_num', title : '已确认还款', width : 110,sortable:true,
	  		   ...
	  		   {field : 'back_paid', title : '已确认佣金', width : 110,sortable:true,
		 			formatter : function(value, row, index) {
	 					if (null==value) {
	 						return "0.00";
	 					}else if (''==value) {
              ...
              {field : 'rate', title : '平均费率', width :110,sortable:true,
	 			formatter : function(value, row, index) {
 					if (null==value) {
 						return "0.00%";
 					}else if (''==value) {
	...
	function search() {
		 var options = _datagrid.datagrid('options');
			//url 需要自己定义
			options.url = baseUrl + '/queryEntrust';
		//重新加载datagrid
