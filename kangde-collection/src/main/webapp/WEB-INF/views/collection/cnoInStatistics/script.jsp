...
<script type="text/javascript" charset="utf-8">
	...
	var _search_form;
	//请求基础路径
	var baseUrl = ctx + "/collection/cnoInStatistics";
...
// 			pageList : [ 20, 50, 100 ],
            ...
            {field : 'cno', title : '坐席号', width : 110,sortable:true},
 			{field : 'callInCount', title : '来电次数', width : 110,sortable:true},
 			{field : 'callInConnectCount', title : '来电接通次数', width : 110,sortable:true},
 			{field : 'callInConnectDuration', title : '来电接通时长', width : 110,sortable:true},
 			{field : 'callInConnectDurationAvg', title : '平均来电接通时长', width : 120,sortable:true},
 			{field : 'callInConnectRate', title : '来电接通率', width : 110,sortable:true,
 			...
 			/* {field : 'bridgeDurationDayAvg', title : '平均每日通话时长（时:分:秒）', width : 110} */
             ] ],
