...
<jsp:include page="recordscript.jsp"></jsp:include>
<style>
#table_query {
...
<div class="easyui-layout" fit="true"
	...
	<div
		...
		style="padding: 0px; height: 40px; width: 100%; margin-top: 5px; overflow-y: hidden;">
...
<!-- 			<table id='table_query'> -->
			<table>
				<tr>
					...
					<td></td>
					<td><span style='margin-left: 5px;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
							class="easyui-linkbutton" href="#"
							data-options="width:70,height:23,onClick:search"><span
								style="color: white;">查&nbsp;&nbsp;询</span></a> <a
							class="easyui-linkbutton" href="#"
							data-options="width:70,height:23"
