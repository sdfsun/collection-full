...
<script type="text/javascript" charset="utf-8">
	...
	var _search_form;
	//请求基础路径
	var baseUrl = ctx + "/collection/timeOutStatistics";
...
// 			pageList : [ 20, 50, 100 ],
            ...
            {field : 'time', title : '时间', width : 110,sortable:true,
 			...
 			{field : 'callOutConnectDurationAvg', title : '平均致电通话时长', width : 120,sortable:true},
 			{field : 'callOutConnectRate', title : '致电接通率', width : 110,sortable:true,
 				formatter : function(value, row, index) {
 					if (null == value) {
						return "0.00%";
					} else if ('' == value) {
