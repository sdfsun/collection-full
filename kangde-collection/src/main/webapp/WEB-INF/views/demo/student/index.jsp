...
<div class="easyui-layout" fit="true" style="margin: 0px;border: 0px;overflow: hidden;width:100%;height:100%;">
    <div data-options="region:'north',title:'过滤条件',collapsed:false,split:false,border:false"
        ...
        <form id="_search_form" style="padding: 5px;">
            &nbsp;角色名称: &nbsp;<input type="text" class="easyui-validatebox textbox eu-input" name="name" placeholder="请输入角色名称..."
            ...
            <a class="easyui-linkbutton" href="#" data-options="iconCls:'easyui-icon-no',width:100,height:28" onclick="javascript:_search_form.form('reset');">重置查询</a>
        </form>
    </div>
    <%-- 中间部分 列表 --%>
