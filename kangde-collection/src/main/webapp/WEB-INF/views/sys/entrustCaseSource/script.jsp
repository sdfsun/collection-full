...
var _dialog;
//请求基础路径
var baseUrl = ctx+"/sys/entrustCaseSource";
...
$(function () {
    ...
    _datagrid = $('#_datagrid').datagrid({
        ...
        columns:[[
			...
			/* 客户状态 合同名称 委托方 简码 案源地 简码 添加日期 修改日期 初始营业员
 */
 			...
 			{field:'contract_name',title:'合同名称',width:100},
 			{field:'en_name',title:'委托方',width:100},
 			{field:'en_code',title:'委托方简码',width:100},
 			{field:'name',title:'案源地',width:100},
 			{field:'code',title:'案源地简码',width:100},
 			...
 			{field:'modifyTime',title:'修改日期',width:150,
 				formatter:function(value, row, index){
             		if(value){
...
function showDialog(row) {
    ...
    //弹出对话窗口,保存按钮函数,标题,宽度,高度,请求路径,请求方式,表单加载数据函数（可以为空）
   	_dialog = app.openFormDialog(function(){
   		_form.submit();//提交表单
   	}, '案源地', 450, 220, inputUrl, 'GET', function(){
   		//初始化会话页面组件
   		formInit();
