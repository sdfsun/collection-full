...
public abstract class HttpRequestUtils {
	...
	/**
	 * 解析json 将unicode格式转换为中文格式
	 * @param ori
	 * @return 解析后json（中文）
	 */
	public static String unicodeToCn(String ori) {
		char aChar;
		int len = ori.length();
	...
	public static void main(String[] args) {
		try {
			String a = HttpRequestUtils.sendGet("http://10.13.0.44:8000/shixin", "name=纪付宁&idcode=37282619740****183X");
			String b = unicodeToCn(a);
